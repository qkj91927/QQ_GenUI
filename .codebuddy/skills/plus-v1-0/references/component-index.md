...
- `PRO_navbar` → `md/PRO_NAVBAR_COMPONENT_SPEC.md` + `json/components/PRO-navbar.json`
- `PRO_tabbar` → `md/PRO_TABBAR_COMPONENT_SPEC.md` + `json/components/PRO-tabbar.json`
...
- 未明确要求 Pro/高级组件时，默认仅使用 20 个基础母组件
